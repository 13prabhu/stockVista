    ...
    <div className="container mt-5 border-top  bg-light" >
      <div className="row mt-5">
        <div className="col">
          ...
          <p sty className="mt-3">&copy; 2010 - 2024, Zerodha Broking Ltd. All rights reserved.</p>
        </div>
        <div className="col">
      ...
      <div className="mt-5 text-small text-muted " style={{fontSize:"0.7rem"}}>
      ...
      <div className="footer-links" style={{textAlign:"center"}}>
        <p><a href="">NSE</a><a href="">BSE</a><a href="">MCX</a><a href="">Terms & conditions</a><a href="">Policies & procedures </a><a href="">Privacy policy  </a><a href="">Disclosure</a><a href="">For investor's attention </a><a href="">Investor charter</a></p>
      </div>
    </div>
    </footer>
  );
